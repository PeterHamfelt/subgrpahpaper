...
# Calculate attribute-based anomaly scores
...
# Calculate weighted attribute-based anomaly scores
w_attr = 0.4
weighted_attribute_anomaly_scores = [score * w_attr for score in attribute_anomaly_scores]

# Identify anomalies
anomalies = [i for i, score in enumerate(weighted_attribute_anomaly_scores) if score > 0]
